...
public class ClienteController {
    ...
    private ClienteService clienteService;
        ...
        @GetMapping("/rut/{rut}") // Solicitudes GET
        ...
        @GetMapping // Solicitudes GET para obtener todos los clientes
        ...
        @DeleteMapping("/{id}") // solicitudes DELETE
